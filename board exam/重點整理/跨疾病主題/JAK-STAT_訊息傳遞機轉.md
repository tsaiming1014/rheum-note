...
## 十一、跨家族比較：IL-12 vs IL-15 對 NK 細胞的分工

IL-12（IL-12/23家族）與 IL-15（common γc家族）都會影響 NK 細胞，但分屬不同家族、不同 JAK/STAT、不同任務層級，容易混淆。一句話記憶：**IL-15 決定 NK 細胞「有沒有兵」，IL-12（+IL-18）決定「兵現在要不要開槍」。**

### IL-12：讓已存在的 NK 細胞「更會殺」，不是讓 NK 細胞「存在」

Janeway 教科書明確指出：未感染的個體體內就能分離出具有殺傷能力的 NK 細胞，但當 NK 細胞暴露在 IFN-α/β 或 **IL-12**（由巨噬細胞、樹突細胞在感染時產生）之下，殺傷活性會**增強 20 到 100 倍**；IL-12 並與 **IL-18 協同作用**，刺激 NK 細胞分泌大量 IFN-γ。

也就是說，IL-12 作用的對象是**已經存在、已經成熟**的 NK 細胞，工作是在感染當下「下派工單」——叫 NK 細胞立刻大量分泌 IFN-γ、加強細胞毒殺能力，不負責 NK 細胞打哪來、能活多久。這也是它被命名為 **NK-cell Stimulatory Factor (NKSF)** 的由來——「stimulatory」指的是活化，而非生成。

### IL-15：NK 細胞的「出生證＋終身生活費」

IL-15 是 NK 細胞從造血幹細胞分化出來、以及分化後在周邊持續存活都不可或缺的因子——屬於「發育與存活（development & survival/homeostasis）」層級，而非臨時活化層級。

IL-15 有特殊的呈現方式叫 **trans-presentation**：不像一般 cytokine 分泌到血液中讓遠處細胞接收，而是先被樹突細胞、巨噬細胞、基質細胞用自己表面的 IL-15Rα 抓住、呈現在細胞表面，直接遞給旁邊表達 CD122(IL-2Rβ)+CD132(γc) 的 NK 細胞/記憶 CD8 T 細胞——類似「面對面遞交」而非「郵寄」。這也是為什麼 IL-15 缺乏會導致 **NK 細胞數目直接減少**（不是功能變差，是數目變少）。

### 機轉對照表

| | IL-12 | IL-15 |
|---|---|---|
| 分泌細胞 | 巨噬細胞、樹突細胞（感染當下急性分泌） | 樹突細胞、巨噬細胞、基質細胞（trans-presentation） |
| JAK/STAT | JAK2+TYK2 → **STAT4** | JAK1+JAK3 → **STAT5** |
| 對 NK 細胞的角色 | **活化**：增強IFN-γ分泌（與IL-18協同）、增強細胞毒殺力（20-100倍） | **發育＋存活**：決定NK細胞能不能生成、能不能長期存活 |
| 缺乏時的後果 | NK 細胞仍存在，但活化反應/IFN-γ production 減弱 | **NK 細胞數目直接減少**（因為連活下去都需要它） |
| 時間尺度 | 急性、感染當下 | 慢性、恆定（homeostatic） |
| 是否需要細胞接觸 | 不需要（可溶性分泌） | **需要（trans-presentation）** |
