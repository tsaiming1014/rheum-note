...
- **入口用「慢性背痛」非 IBP**：ASAS 中軸（IBP 只是 SpA 特徵之一；11 項特徵見三之一節）
...
1. 哪些分類標準是「計分制」？各需幾分達標？

<details><summary>答案</summary>

Amor（≥6 分）、CASPAR（≥3 分）、2025 axSpA（≥11 分）。

</details>

2. 2009 ASAS axSpA：影像臂與臨床臂各需幾項 SpA feature？（最愛考陷阱）

<details><summary>答案</summary>

影像臂只需 ≥1 項；臨床臂（HLA-B27 陽性）需 ≥2 項。

</details>

3. 特異度最高的分類標準是哪個？約多少？其中唯一給 2 分的項目是？

<details><summary>答案</summary>

CASPAR（PsA），specificity ~98.7%；唯一給 2 分的是「現有乾癬」。

</details>

4. AS 病人 HLA-B27 陽性率約多少？HLA-B27 占 AS 總遺傳度又是多少？（陷阱）

<details><summary>答案</summary>

陽性率 ~90%，但只占 AS 總遺傳度 **33%**（AS 整體遺傳度 >90%）。

</details>

5. 2025 axSpA 標準的 cut-off 與三條路徑？相較 2009 版 sens/spec 怎麼變、為什麼？

<details><summary>答案</summary>

≥11 分；MRI +≥3、X 光 +≥4、HLA-B27 +≥7。相較 2009 版，specificity 大升（77.1%→90.4%）、sensitivity 略降（82.4%→79.5%），因高度依賴 MRI。
