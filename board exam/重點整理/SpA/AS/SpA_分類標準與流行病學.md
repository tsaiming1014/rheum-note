...
### IBP 本身的定義（ASAS 2009 專家共識）

> 上面 11 項 SpA features 中的第 1 項「IBP」，其操作型定義如下（與「進入條件＝慢性背痛」不同，屬於更嚴格的篩檢工具）：

在慢性下背痛（≥3 個月）病人中，符合以下 **5 項中 ≥4 項**即可判定為 IBP：

1. 發病年齡 **< 40 歲**
2. **隱匿性發作**（insidious onset，非外傷/急性）
3. **運動後改善**（improvement with exercise）
4. **休息無法改善**（no improvement with rest）
5. **夜間疼痛**（尤其下半夜），起床後會改善

**效能**：敏感度 ~77%、特異度 ~72–80%（不同研究略有差異）——是「篩檢工具」，不是診斷/分類標準本身。

**歷史演進**：

| 版本 | 年份 | 內容 |
|---|---|---|
| **Calin criteria** | 1977 | 最早版本，5 項中符合 4 項：發病 <40歲、隱匿發作、>3個月、晨僵、運動後改善 |
| **Berlin criteria** | 2006 | 精簡為 4 項（晨僵>30分、運動後改善非休息後、下半夜痛醒、交替性臀部痛），符合 **≥2/4** |
| **ASAS expert criteria** | 2009 | 整合上述，**5 項符合 ≥4 項**（如上），目前最常用版本 |
...
> 對照本筆記「四、HLA-B27 關鍵數字」：圖中 AS 的 B27 90%、PsA 20%（原文寫周邊型），與此圖 PsA 40–50% 略有出入（可能未分軸向/周邊亞型），僅供交叉比對參考。
